const Home = (): React.JSX.Element => {
    return (
        <div className="flex-1 intro-wrapper px-5 py-20 flex flex-col justify-center items-center bg-stone-200 dark:bg-dark">
            <h1
                className="text-4xl sm:text-6xl my-5 text-gray-700 text-center dark:text-gray-300 transition-colors duration-200 ease-in-out"
            >Welcome to Blog API</h1>
            <p
                className="my-4 w-full max-w-[900px] text-xs sm:text-base text-gray-700 text-center dark:text-gray-300"
